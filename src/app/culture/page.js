...
export default function Culture() {
  ...
  <p>Once upon a time, there lived a {params.adjective} armadillo. Their name was {params.name}. {params.name} loved to {params.verb1}, {params.verb2}, and {params.verb3}. One day, {params.name} saw a {params.object} sitting in the {params.waterName}. {params.name} decided to {params.action} the {params.object}, and said "I can't wait to go home and show my family this {params.object}!" Once {params.name} came home, they showed the {params.object} to their family, who {params.verb4} after seeing it! {params.name} was confused until they looked closer. It was actually a {params.object2}! {params.name}'s family all {params.verb5}, and they all lived {params.ending}.</p>
  </div>
  )}
  </div>
  </div>
