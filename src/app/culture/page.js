...
export default function Culture() {
  ...
  <InfoCard title="Mexico" content="In indigenous South American cultures around Mexico, the Armadillo is prominent throughout many stories, signifying bountiful crops and a good harvest."/>
  <InfoCard title="Argentina" content="In Argentinian cultures, the Armadillo is represented as clever and quick-witted, and it is found in many stories and tales, including 'The Armadillo and the Fox'." />
  </div>
  </div>
  </div>
  </div>;
